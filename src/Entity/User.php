...
class User implements UserInterface
{
     ...
     * @ORM\Column(type="string", length=255)
     *     @assert\Regex(
     *     pattern="/(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[+\-#@$*_%])([\w+\-#@$*_%]{8,15})/",
     *     message="Votre mot de passe doit comporté au minimum 8 caractères, une minuscule, une
     ...
     *     message="La validation est différente du mot de passe entré"
     * )
     */
